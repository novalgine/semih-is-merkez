                            ...
                            {activeClients.length > 0 ? (
                                activeClients.map((client) => (
                                    <Link key={client.id} href={`/customers/${client.id}`}>
                                        <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] hover:bg-white/[0.05] transition-colors group/item cursor-pointer border border-white/[0.05]">
                                ...
                                <p className="text-zinc-500 text-sm italic">Aktif müşteri bulunamadı.</p>
                            )}
                        </div>
                    </InteractiveCard>
                </motion.div>
                            ...
                            {upcomingShoots.length > 0 ? (
                                upcomingShoots.map((shoot) => (
                                    <Link key={shoot.id} href={`/shoots/${shoot.id}`}>
                                        <div className="flex items-center gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/[0.05] hover:border-white/[0.1] transition-colors group/shoot">
                                ...
                                <p className="text-zinc-500 text-sm italic col-span-2">Yaklaşan çekim bulunamadı.</p>
                            )}
                        </div>
                    </InteractiveCard>
                </motion.div>
